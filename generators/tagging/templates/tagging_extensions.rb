...
class ActiveRecord::Base #:nodoc:
  ...
  # Extensions to make models taggable. Reopens ActiveRecord::Base. This file is automatically generated and required by your app if you run the tagging generator included with has_many_polymorphs.
  ...
  <% end -%>
   ...
   # Returns the tags on <tt>self</tt> as a string.
    ...
    # Replace the existing tag set. Accepts a string of tagnames, an array of tagnames, an array of ids, or an array of Tags.
    def tag_with list    
      #:stopdoc:
      taggable?(true)
